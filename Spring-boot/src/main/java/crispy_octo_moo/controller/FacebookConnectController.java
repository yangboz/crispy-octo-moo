...
//	}
	...
	@ApiOperation(httpMethod = "GET", value = "Response a string describing if the access_token related user profile is successfully received.")
	public JsonObject getByToken(@PathVariable("token") String accessToken) {
