...
public final class Constants {
    ...
    public static final String T_NAME_CONTACT_PHONE = "contact_phone";
    public static final String T_NAME_CONTACT_URL = "contact_url";
    public static final String T_NAME_USER = "user";
}